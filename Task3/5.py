...
INPUT = os.path.join(BASE, "input", "5.png")
OUTPUT = os.path.join(BASE, "output", "5.png")
...
# =========================================================
# OBSTACLE: BLUE CYLINDERS (Updated for Blue Color Range)
# =========================================================
...
# =========================================================
# DRAW OBSTACLES (CUSTOM PLACEMENT FOR BLUE CYLINDERS)
# =========================================================
...
for i, (x, y, w, hh) in enumerate(obstacles, 1):
    ...
    if i == 1:
        # Obstacle 1 (Left blue cylinder): placed safely above the top edge
        text_x = x
        text_y = y - 10
    else:
        # Obstacle 2 (Right blue cylinder): placed cleanly in the open space below the box
        text_x = x - 70
        text_y = y + hh + 28
