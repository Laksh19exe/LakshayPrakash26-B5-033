...
INPUT = os.path.join(BASE, "input", "4.png")
OUTPUT = os.path.join(BASE, "output", "4.png")
...
# =========================================================
# OBSTACLE: YELLOW CYLINDERS / OBJECTS
# =========================================================
...
# =========================================================
# DRAW OBSTACLES (EXACTLY IN YOUR RED MARKED AREA)
# =========================================================
...
for i, (x, y, w, hh) in enumerate(obstacles, 1):
    ...
    if i == 1:
        # Obstacle 1: top of the left box
        text_x = x
        text_y = y - 10
    else:
        # Obstacle 2: placed right in the empty space below the boxes where you drew the red box
        text_x = x - 70
        text_y = y + hh + 28
